!(function (h) {
    h.fn.stellarNav = function (t, o, a) {
        (nav = h(this)), (o = h(window).width());
        var r = h.extend({ theme: "plain", breakpoint: 768, phoneBtn: !1, locationBtn: !1, sticky: !1, position: "static", showArrows: !0, closeBtn: !1, scrollbarFix: !1 }, t);
        return this.each(function () {
            function t() {
                nav.find("li").unbind("mouseenter"), nav.find("li").unbind("mouseleave");
            }
            var e, i, s;
            ("light" != r.theme && "dark" != r.theme) || nav.addClass(r.theme),
                r.breakpoint && (a = r.breakpoint),
                (s = r.phoneBtn && r.locationBtn ? "third" : r.phoneBtn || r.locationBtn ? "half" : "full"),
                nav.prepend('<a href="#" class="menu-toggle ' + s + '"><i class="fa fa-bars"></i></a>'),
                r.phoneBtn &&
                    "right" != r.position &&
                    "left" != r.position &&
                    ((e = '<a href="tel:' + r.phoneBtn + '" class="call-btn-mobile ' + s + '"><i class="fa fa-phone"></i> <span>Call us</span></a>'), nav.find("a.menu-toggle").after(e)),
                r.locationBtn &&
                    "right" != r.position &&
                    "left" != r.position &&
                    ((e = '<a href="' + r.locationBtn + '" class="location-btn-mobile ' + s + '" target="_blank"><i class="fa fa-map-marker"></i> <span>Location</span></a>'), nav.find("a.menu-toggle").after(e)),
                r.sticky &&
                    ((navPos = nav.offset().top), a <= o) &&
                    h(window).bind("scroll", function () {
                        h(window).scrollTop() > navPos ? nav.addClass("fixed") : nav.removeClass("fixed");
                    }),
                "top" == r.position && nav.addClass("top"),
                ("left" != r.position && "right" != r.position) ||
                    ((e = '<a href="#" class="close-menu ' + s + '"><i class="fa fa-close"></i> <span>Close</span></a>'),
                    (i = '<a href="tel:' + r.phoneBtn + '" class="call-btn-mobile ' + s + '"><i class="fa fa-phone"></i></a>'),
                    (s = '<a href="' + r.locationBtn + '" class="location-btn-mobile ' + s + '" target="_blank"><i class="fa fa-map-marker"></i></a>'),
                    nav.find("ul:first").prepend(e),
                    r.locationBtn && nav.find("ul:first").prepend(s),
                    r.phoneBtn && nav.find("ul:first").prepend(i)),
                "right" == r.position && nav.addClass("right"),
                "left" == r.position && nav.addClass("left"),
                r.showArrows || nav.addClass("hide-arrows"),
                r.closeBtn && "right" != r.position && "left" != r.position && nav.find("ul:first").append('<li><a href="#" class="close-menu"><i class="fa fa-close"></i> Close Menu</a></li>'),
                r.scrollbarFix && h("body").addClass("stellarnav-noscroll-x"),
                h(".menu-toggle").on("click", function (t) {
                    t.preventDefault(),
                        "left" == r.position || "right" == r.position
                            ? (nav.find("ul:first").stop(!0, !0).fadeToggle(250),
                              ...
                              nav.hasClass("active") &&
                                  ...
                                  h(document).on("click", function (t) {
                                      !nav.hasClass("mobile") || h(t.target).closest(nav).length || (nav.find("ul:first").stop(!0, !0).fadeOut(250), nav.removeClass("active"));
                                  }))
                            : (nav.find("ul:first").stop(!0, !0).slideToggle(250), nav.toggleClass("active"));
                }),
                h(".close-menu").click(function () {
                    nav.removeClass("active"), "left" == r.position || "right" == r.position ? nav.find("ul:first").stop(!0, !0).fadeToggle(250) : nav.find("ul:first").stop(!0, !0).slideUp(250).toggleClass("active");
                }),
                nav.find("li a").each(function () {
                    var t;
                    0 < h(this).next().length && (h(this).parent("li").addClass("has-sub"), (t = h(this).parent("li").children("ul")), h('<a class="dd-toggle" href="#"><i class="fa fa-plus"></i></a>').insertBefore(t));
                }),
                nav.find("li .dd-toggle").on("click", function (t) {
                    t.preventDefault(), h(this).parent("li").children("ul").stop(!0, !0).slideToggle(250), h(this).parent("li").toggleClass("open");
                });
            function n() {
                window.innerWidth <= a
                    ? (t(), nav.addClass("mobile"), nav.removeClass("desktop"), !nav.hasClass("active") && nav.find("ul:first").is(":visible") && nav.find("ul:first").hide())
                    : (nav.addClass("desktop"),
                      nav.removeClass("mobile"),
                      nav.hasClass("active") && nav.removeClass("active"),
                      !nav.hasClass("active") && nav.find("ul:first").is(":hidden") && nav.find("ul:first").show(),
                      h("li.open").removeClass("open").find("ul:visible").hide(),
                      t(),
                      nav.find("li").on("mouseenter", function () {
                          h(this).addClass("hover"), h(this).children("ul").stop(!0, !0).slideDown(250);
                      }),
                      nav.find("li").on("mouseleave", function () {
                          h(this).removeClass("hover"), h(this).children("ul").stop(!0, !0).slideUp(250);
                      }));
            }
            n(),
    ...
    (function (t) {
        ...
        function t() {
            for (var t = d.scrollTop(), e = p.height(), i = e - g, s = i < t ? i - t : 0, n = 0, o = u.length; n < o; n++) {
                var a,
                    r,
                    h = u[n],
                    l = h.stickyWrapper.offset().top - h.topSpacing - s;
                h.stickyWrapper.css("height", h.stickyElement.outerHeight()),
                    t <= l
                        ...
                        : ((l = e - h.stickyElement.outerHeight() - h.topSpacing - h.bottomSpacing - t - s) < 0 ? (l += h.topSpacing) : (l = h.topSpacing),
                          h.currentTop !== l &&
                              (h.getWidthFrom ? ((padding = h.stickyElement.innerWidth() - h.stickyElement.width()), (a = c(h.getWidthFrom).width() - padding || null)) : h.widthFromWrapper && (a = h.stickyWrapper.width()),
                              null == a && (a = h.stickyElement.width()),
                              h.stickyElement.css("width", a).css("position", "fixed").css("top", l).css("z-index", h.zIndex),
                              ...
                              (h.currentTop === h.topSpacing && h.currentTop > l) || (null === h.currentTop && l < h.topSpacing)
                                  ? h.stickyElement.trigger("sticky-bottom-reached", [h])
                                  : null !== h.currentTop && l === h.topSpacing && h.currentTop < l && h.stickyElement.trigger("sticky-bottom-unreached", [h]),
                              (h.currentTop = l)),
                          (r = h.stickyWrapper.parent()),
                          h.stickyElement.offset().top + h.stickyElement.outerHeight() >= r.offset().top + r.outerHeight() && h.stickyElement.offset().top <= h.topSpacing
                              ? h.stickyElement.css("position", "absolute").css("top", "").css("bottom", 0).css("z-index", "")
                              : h.stickyElement.css("position", "fixed").css("top", l).css("bottom", "").css("z-index", h.zIndex));
            }
        }
        function e() {
            g = d.height();
            for (var t = 0, e = u.length; t < e; t++) {
                var i = u[t],
                    s = null;
                i.getWidthFrom ? i.responsiveWidth && (s = c(i.getWidthFrom).width()) : i.widthFromWrapper && (s = i.stickyWrapper.width()), null != s && i.stickyElement.css("width", s);
            }
        }
        var i = Array.prototype.slice,
            ...
            r = {
                init: function (o) {
                    return this.each(function () {
                        var t = c.extend({}, a, o),
                            ...
                            n = c("<div></div>").attr("id", s).addClass(t.wrapperClassName),
                            i =
                                (e.wrapAll(function () {
                                    if (0 == c(this).parent("#" + s).length) return n;
                                }),
                                e.parent());
                        t.center && i.css({ width: e.outerWidth(), marginLeft: "auto", marginRight: "auto" }),
                            "right" === e.css("float") && e.css({ float: "none" }).parent().css({ float: "right" }),
                            (t.stickyElement = e),
                            (t.stickyWrapper = i),
                            (t.currentTop = null),
                            u.push(t),
                            r.setWrapperHeight(this),
                            r.setupChangeListeners(this);
                    });
                },
                ...
                unstick: function (t) {
                    return this.each(function () {
                        for (var t = c(this), e = -1, i = u.length; 0 < i--; ) u[i].stickyElement.get(0) === this && (s.call(u, i, 1), (e = i));
                        -1 !== e && (t.unwrap(), t.css({ width: "", position: "", top: "", float: "", "z-index": "" }));
                    });
                },
            };
        window.addEventListener ? (window.addEventListener("scroll", t, !1), window.addEventListener("resize", e, !1)) : window.attachEvent && (window.attachEvent("onscroll", t), window.attachEvent("onresize", e)),
            (c.fn.sticky = function (t) {
                return r[t] ? r[t].apply(this, i.call(arguments, 1)) : "object" != typeof t && t ? void c.error("Method " + t + " does not exist on jQuery.sticky") : r.init.apply(this, arguments);
            }),
            (c.fn.unstick = function (t) {
                return r[t] ? r[t].apply(this, i.call(arguments, 1)) : "object" != typeof t && t ? void c.error("Method " + t + " does not exist on jQuery.sticky") : r.unstick.apply(this, arguments);
            }),
            c(function () {
                setTimeout(t, 0);
            });
        ...
        (l.Defaults = {
            ...
            (l.Workers = [
                ...
                },
                {
                    ...
                    run: function () {
                        ...
                        (this._clones = t), h(a).addClass("cloned").appendTo(this.$stage), h(r).addClass("cloned").prependTo(this.$stage);
                    },
                },
                {
                    filter: ["width", "items", "settings"],
                ...
                },
                {
                    ...
                    run: function () {
                        for (var t, e, i = this.settings.rtl ? 1 : -1, s = 2 * this.settings.stagePadding, n = this.coordinates(this.current()) + s, o = n + this.width() * i, a = [], r = 0, h = this._coordinates.length; r < h; r++)
                            (t = this._coordinates[r - 1] || 0), (e = Math.abs(this._coordinates[r]) + s * i), ((this.op(t, "<=", n) && this.op(t, ">", o)) || (this.op(e, "<", n) && this.op(e, ">", o))) && a.push(r);
            ...
            (l.prototype.initialize = function () {
                ...
                this.enter("initializing"),
                    ...
                    this.settings.autoWidth &&
                        !this.is("pre-loading") &&
                        ((t = this.$element.find("img")), (e = this.settings.nestedItemSelector ? "." + this.settings.nestedItemSelector : r), (e = this.$element.children(e).width()), t.length) &&
                        e <= 0 &&
            ...
            (l.prototype.to = function (t, e) {
                var i = this.current(),
                    ...
                    r = this.maximum();
                this.settings.loop
                    ? (!this.settings.rewind && Math.abs(s) > o / 2 && (s += -1 * n * o), (n = (((((t = i + s) - a) % o) + o) % o) + a) !== t && n - s <= r && 0 < n - s && this.reset((i = (t = n) - s)))
                    : (t = this.settings.rewind ? ((t % (r += 1)) + r) % r : Math.max(a, Math.min(r, t))),
            ...
            (l.prototype.trigger = function (t, e, i, s, n) {
                var o = { item: { count: this._items.length, index: this.current() } },
                    ...
                    r = h.Event([t, "owl", i || "carousel"].join(".").toLowerCase(), h.extend({ relatedTarget: this }, o, e));
                return (
                    this._supress[t] ||
        ...
        (e.Defaults = { lazyLoad: !1, lazyLoadEager: 0 }),
            (e.prototype.load = function (t) {
                var t = this._core.$stage.children().eq(t),
                    e = t && t.find(".owl-lazy");
                !e ||
                    -1 < r.inArray(t.get(0), this._loaded) ||
                    (e.each(
    ...
    (function (c, e) {
        ...
        (i.Defaults = { video: !1, videoHeight: !1, videoWidth: !1 }),
            ...
            (i.prototype.thumbnail = function (e, t) {
                ...
                if ((e.wrap(c("<div/>", { class: "owl-video-wrapper", style: o })), this._core.settings.lazyLoad && ((r = "data-src"), (h = "owl-lazy")), a.length)) return i(a.attr(r)), a.remove(), !1;
                "youtube" === t.type
                ...
                1 === this.core.settings.items &&
                    ...
                    (o &&
                        ...
                        i
                            ...
                            .addClass(o)),
                    n) &&
                    s.one(a.support.animation.end, e).addClass("animated owl-animated-in").addClass(n);
            }),
    ...
    (function (u) {
        u.fn.theiaStickySidebar = function (t) {
            ...
            function s(t, e) {
                if (!0 !== t.initialized) {
                    if (u("body").width() < t.minWidth) return !1;
                    var d = t,
                        t = e;
                    (d.initialized = !0),
                        0 === u("#theia-sticky-sidebar-stylesheet-" + d.namespace).length &&
                            u("head").append(u('<style id="theia-sticky-sidebar-stylesheet-' + d.namespace + '">.theiaStickySidebar:after {content: ""; display: table; clear: both;}</style>')),
                        t.each(function () {
                            var i,
                                t,
                                e,
                                ...
                                o =
                                    ((n.sidebar = u(this)),
                                    (n.options = d || {}),
                                    (n.container = u(n.options.containerSelector)),
                                    ...
                                    0 == n.stickySidebar.length &&
                                        ...
                                        n.sidebar
                                            ...
                                            .remove(),
                                        (n.stickySidebar = u("<div>").addClass("theiaStickySidebar").append(n.sidebar.children())),
                            ...
                            n.stickySidebar.css("padding-top", 1),
                                ...
                                (o -= n.stickySidebar.offset().top),
                                (a = n.stickySidebar.outerHeight() - a - o),
                                0 == o ? (n.stickySidebar.css("padding-top", 0), (n.stickySidebarPaddingTop = 0)) : (n.stickySidebarPaddingTop = 1),
                                0 == a ? (n.stickySidebar.css("padding-bottom", 0), (n.stickySidebarPaddingBottom = 0)) : (n.stickySidebarPaddingBottom = 1),
                                (n.previousScrollTop = null),
                                (n.fixedScrollTop = 0),
                                c(),
                                (n.onScroll = function (t) {
                                    if (t.stickySidebar.is(":visible"))
                                        if (u("body").width() < t.options.minWidth) c();
                                        else {
                                            if (t.options.disableOnResponsiveLayouts) if (t.sidebar.outerWidth("none" == t.sidebar.css("float")) + 50 > t.container.width()) return void c();
                                            var e,
                                                i,
                                                s,
                                                n,
                                                ...
                                                a,
                                                r,
                                                h = u(document).scrollTop(),
                                                l = "static";
                                            h >= t.sidebar.offset().top + (t.paddingTop - t.options.additionalMarginTop) &&
                                                ((i = t.paddingTop + d.additionalMarginTop),
                                                (a = t.paddingBottom + t.marginBottom + d.additionalMarginBottom),
                                                ...
                                                (n =
                                                    ...
                                                    n.children().each(function () {
                                                        o = Math.max(o, u(this).height());
                                                    }),
                                                    o)),
                                                (e = 0 + d.additionalMarginTop),
                                                (i = t.stickySidebar.outerHeight() + i + a < u(window).height() ? e + t.stickySidebar.outerHeight() : u(window).height() - t.marginBottom - t.paddingBottom - d.additionalMarginBottom),
                                                (a = r - h + t.paddingTop),
                                                (r = n - h - t.paddingBottom - t.marginBottom),
                                                (n = t.stickySidebar.offset().top - h),
                                                (s = t.previousScrollTop - h),
                                                "fixed" == t.stickySidebar.css("position") && "modern" == t.options.sidebarBehavior && (n += s),
                                                "stick-to-top" == t.options.sidebarBehavior && (n = d.additionalMarginTop),
                                                "stick-to-bottom" == t.options.sidebarBehavior && (n = i - t.stickySidebar.outerHeight()),
                                                (n = 0 < s ? Math.min(n, e) : Math.max(n, i - t.stickySidebar.outerHeight())),
                                                (n = Math.max(n, a)),
                                                (n = Math.min(n, r - t.stickySidebar.outerHeight())),
                                                (l =
                                                    ((s = t.container.height() == t.stickySidebar.outerHeight()) || n != e) && (s || n != i - t.stickySidebar.outerHeight())
                                                        ? h + n - t.sidebar.offset().top - t.paddingTop <= d.additionalMarginTop
                                                            ? "static"
                                                            : "absolute"
                                                        : "fixed")),
                                                "fixed" == l
                                                    ? ((a = u(document).scrollLeft()),
                                                      t.stickySidebar.css({
                                                          position: "fixed",
                                                    ...
                                                    ? ((r = {}),
                                                      "absolute" != t.stickySidebar.css("position") &&
                                                          ((r.position = "absolute"), (r.transform = "translateY(" + (h + n - t.sidebar.offset().top - t.stickySidebarPaddingTop - t.stickySidebarPaddingBottom) + "px)"), (r.top = "0px")),
                                                      (r.width = p(t.stickySidebar) + "px"),
                                                      (r.left = ""),
                                                      t.stickySidebar.css(r))
                                                    : "static" == l && c(),
                                                "static" != l && 1 == t.options.updateSidebarHeight && t.sidebar.css({ "min-height": t.stickySidebar.outerHeight() + t.stickySidebar.offset().top - t.sidebar.offset().top + t.paddingBottom }),
                                                (t.previousScrollTop = h);
                                        }
                                }),
                                n.onScroll(n),
                                u(document).on(
    ...
    (function (e) {
        ...
        jQuery(document).ready(function () {
            var t = !1;
            jQuery("body").on("click", ".search_box-mobile", function () {
                jQuery(".header-search-container-mobile").toggle();
            })
            jQuery("body").hasClass("rtl") && (t = !0),
                "1" == cream_magazine_script_obj.enable_sticky_menu_section && e("nav.main-navigation").sticky(),
                jQuery(".primary-navigation").stellarNav({ theme: "dark", breakpoint: 991, closeBtn: !1, scrollbarFix: !0, sticky: !1 }),
                "1" == cream_magazine_script_obj.show_search_icon &&
                ...
                jQuery("body").on("click", ".menu-toggle", function (t) {
                    t.preventDefault();
                }),
                "1" == cream_magazine_script_obj.enable_sticky_sidebar && jQuery(".sticky_portion").theiaStickySidebar({ additionalMarginTop: 10 }),
                "1" == cream_magazine_script_obj.show_to_top_btn &&
                ...
                "1" == cream_magazine_script_obj.show_news_ticker &&
                    jQuery(".ticker_carousel").owlCarousel({
                        ...
                        animateIn: "slideInUp",
                        navText: ["<i class='fa fa-arrow-down'></i>", "<i class='fa fa-arrow-up'></i>"],
                    }),
                "1" == cream_magazine_script_obj.show_banner_slider &&
                ...
                jQuery(".middle_widget_six_carousel").owlCarousel({
                    ...
                    autoplayHoverPause: !0,
                    navText: ["<i class='fa fa-angle-left'></i>", "<i class='fa fa-angle-right'></i>"],
                    responsive: { 0: { items: 1 }, 400: { items: 1 }, 576: { items: 2, margin: 15 }, 768: { items: 2, margin: 15 }, 992: { items: 2 }, 1024: { items: 2 }, 1200: { items: 2 } },
                });
        });
    })(jQuery);
