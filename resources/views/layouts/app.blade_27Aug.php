  ...
  "@graph": [
    {
      "@type": "WebSite",
      "name": "MMF News",
      "url": "https://world91.com",
      "potentialAction": {
        "@type": "SearchAction",
        "target": "https://world91.com/search?search={search_term_string}",
    ...
    },
    {
      ...
      "sameAs": [
        "https://www.facebook.com/officialworld91news",
    ...
    function DisplayTitleDescription($title)
    {
        ...
        if (str_contains($URL, 'dharma-gyan')) {
            $DisplayTitle = 'धर्म ज्ञान: Spiritual Insights, Teachings, and Religious News | World 91';
            $DisplayDescription = 'World 91 पर पाएं धर्म, आध्यात्मिकता और जीवन से जुड़ी गहरी शिक्षाएँ। वेद, उपनिषद, धार्मिक अनुष्ठान, और संतों के उपदेशों के साथ आध्यात्मिक यात्रा के बारे में जानें। धर्म ज्ञान के हर पहलू पर विशेषज्ञ विश्लेषण।';
        } elseif (str_contains($URL, 'entertainment')) {
            $DisplayTitle = 'मनोरंजन समाचार: Latest Entertainment News, Movies, Celebrities & More | World 91';
            $DisplayDescription = 'World 91 पर पाएं ताजगी से भरपूर मनोरंजन की खबरें, फिल्म रिव्यू, सेलिब्रिटी गॉसिप, टीवी शो और म्यूजिक इंडस्ट्री की सभी अपडेट्स। मनोरंजन की दुनिया की हर प्रमुख खबर, सिर्फ World 91 पर।';
        } elseif (str_contains($URL, 'exclusive')) {
            $DisplayTitle = 'ताज़ा खबरें, स्पेशल रिपोर्ट्स और ब्रेकिंग स्टोरीज़ | World 91';
            $DisplayDescription = 'World 91 पर पढ़ें एक्सक्लूसिव रिपोर्ट्स, ब्रेकिंग न्यूज़ और विशेष जांच। हर दिन की ताज़ा खबरों के साथ जानें वो ख़बरें, जो आपको कहीं और नहीं मिलेंगी। देश-दुनिया की खास खबरों के लिए जुड़ें World 91 के साथ।';
        } elseif (str_contains($URL, 'world')) {
            $DisplayTitle = 'दुनिया न्यूज़: Latest World News, Global Updates, Breaking Headlines | World 91';
            $DisplayDescription = 'दुनिया भर की ताज़ा खबरें, ब्रेकिंग न्यूज़ और वैश्विक घटनाएँ पढ़ें। राजनीति, समाज, व्यापार, विज्ञान, खेल और अन्य महत्वपूर्ण ख़बरों के लिए जुड़े रहें World 91 के साथ।';
        } elseif (str_contains($URL, 'utility')) {
            $DisplayTitle = 'Utility News: Useful Tips, Guides, Resources & Updates | World 91';
            $DisplayDescription = "World 91 के 'यूटिलिटी' सेक्शन में पाएं उपयोगी टिप्स, गाइड्स और संसाधन जो आपकी ज़िंदगी को आसान बनाएं। स्वास्थ्य, वित्त, टेक्नोलॉजी और अन्य महत्वपूर्ण जानकारी के लिए जुड़े रहें।";
        } elseif (str_contains($URL, 'technology')) {
            $DisplayTitle = 'टेक्नोलॉजी समाचार: Latest Tech Updates, Gadgets, Innovations & Analysis | World 91';
            $DisplayDescription = 'World 91 पर पाएं टेक्नोलॉजी से जुड़ी ताज़ा खबरें, गैजेट्स, इनोवेशन, और डिजिटल दुनिया की प्रमुख घटनाओं का विश्लेषण। स्मार्टफोन, AI, सॉफ़्टवेयर, और नई तकनीकों के बारे में जानें हर अपडेट।';
        } elseif (str_contains($URL, 'sports')) {
            $DisplayTitle = 'खेल समाचार: ताजा खेल अपडेट्स, मैच रिजल्ट्स, विश्लेषण और ब्रेकिंग न्यूज़ | World 91';
            $DisplayDescription = 'World 91 पर पाएं खेल से जुड़ी ताज़ा खबरें, मैच के लाइव रिजल्ट्स, प्रमुख खेल आयोजनों का विश्लेषण और खिलाड़ियों की खबरें। क्रिकेट, फुटबॉल, बैडमिंटन और अन्य खेलों के बारे में सभी अपडेट यहाँ पाएँ।';
        } elseif (str_contains($URL, 'lifestyle')) {
            $DisplayTitle = 'लाइफस्टाइल समाचार: Health, Fashion, Wellness, Tips & Trends | World 91';
            $DisplayDescription = 'World 91 पर पाएं लाइफस्टाइल से जुड़ी ताज़ा खबरें, स्वास्थ्य, फैशन, फिटनेस, और वेलनेस टिप्स। जीवनशैली के नए ट्रेंड्स, शॉपिंग गाइड और मानसिक स्वास्थ्य पर विशेषज्ञ सलाह के लिए जुड़े रहें।';
        } elseif (str_contains($URL, 'podcast')) {
            $DisplayTitle = 'पॉडकास्ट: Latest Episodes, Talks, Interviews & Discussions | World 91';
            $DisplayDescription = 'World 91 के पॉडकास्ट सेक्शन में पाएं ताज़ा एपिसोड्स, दिलचस्प इंटरव्यूज़ और विशेषज्ञों से की गई चर्चा। राजनीति, समाज, बिजनेस, और अन्य विषयों पर गहन बातें सिर्फ World 91 पॉडकास्ट में।';
        } elseif (str_contains($URL, 'state/maharashtra')) {
            $DisplayTitle = 'महाराष्ट्र न्यूज़: Latest Maharashtra News, Breaking Headlines | World 91';
            $DisplayDescription = 'महाराष्ट्र से जुड़ी ताज़ा खबरें, ब्रेकिंग न्यूज़ और इन-डेप्थ एनालिसिस यहां पढ़ें। राजनीति, समाज, उद्योग और अन्य ख़बरों के लिए जुड़े रहें World 91 के साथ।';
        } elseif (str_contains($URL, 'state/bihar')) {
            $DisplayTitle = 'बिहार न्यूज़: Latest Bihar News, Breaking Headlines | World 91';
            $DisplayDescription = 'बिहार से जुड़ी ताज़ा खबरें, ब्रेकिंग न्यूज़ और इन-डेप्थ एनालिसिस यहां पढ़ें। राजनीति, अर्थव्यवस्था, संस्कृति और अन्य ख़बरों के लिए जुड़े रहें World 91 के साथ।';
        } elseif (str_contains($URL, 'state/uttrakhand')) {
            $DisplayTitle = 'उत्तराखंड न्यूज़: Latest Uttarakhand News, Breaking Headlines | World 91';
            $DisplayDescription = 'उत्तराखंड से जुड़ी ताज़ा खबरें, ब्रेकिंग न्यूज़ और इन-डेप्थ एनालिसिस यहां पढ़ें। राजनीति, पर्यावरण, संस्कृति और अन्य ख़बरों के लिए जुड़े रहें World 91 के साथ।';
        } elseif (str_contains($URL, 'state/new-delhi')) {
            $DisplayTitle = 'नई दिल्ली न्यूज़: Latest New Delhi News, Breaking Headlines | World 91';
            $DisplayDescription = 'नई दिल्ली से जुड़ी ताज़ा खबरें, ब्रेकिंग न्यूज़ और इन-डेप्थ एनालिसिस यहां पढ़ें। राजनीति, समाज, सरकार की योजनाएं और अन्य ख़बरों के लिए जुड़े रहें World 91 के साथ।';
        } elseif (str_contains($URL, 'state/jharkhand')) {
            $DisplayTitle = 'झारखंड न्यूज़: Latest Jharkhand News, Breaking Headlines | World 91';
            $DisplayDescription = 'झारखंड से जुड़ी ताज़ा खबरें, ब्रेकिंग न्यूज़ और इन-डेप्थ एनालिसिस यहां पढ़ें। राजनीति, विकास, जनजीवन और अन्य ख़बरों के लिए जुड़े रहें World 91 के साथ।';
        } elseif (str_contains($URL, 'state/uttar-pradesh')) {
            $DisplayTitle = 'उत्तर प्रदेश न्यूज़: Latest Uttar Pradesh News, Breaking Headlines | World 91';
            $DisplayDescription = 'उत्तर प्रदेश से जुड़ी ताज़ा खबरें, ब्रेकिंग न्यूज़ और इन-डेप्थ एनालिसिस यहां पढ़ें। राजनीति, समाज, संस्कृति और अन्य ख़बरों के लिए जुड़े रहें World 91 के साथ।';
        } elseif (str_contains($URL, 'state=maharashtra')) {
            $DisplayTitle = 'महाराष्ट्र विधान सभा चुनाव: Latest Updates, Results, and Analysis | World 91';
            $DisplayDescription = 'महाराष्ट्र विधान सभा चुनाव से जुड़ी ताज़ा खबरें, चुनाव परिणाम, राजनीति और विश्लेषण पढ़ें। जानें महाराष्ट्र के विधानसभा चुनाव के बारे में सभी अपडेट और नतीजे World 91 पर।';
        } elseif (str_contains($URL, 'state=jharkhand')) {
            $DisplayTitle = 'झारखंड विधान सभा चुनाव: Latest Updates, Results, and Analysis | World 91';
            $DisplayDescription = 'झारखंड विधान सभा चुनाव से जुड़ी ताज़ा खबरें, चुनाव परिणाम, और राजनीतिक विश्लेषण पढ़ें। झारखंड विधानसभा चुनाव के बारे में हर अपडेट और नतीजे पाएँ World 91 पर।';
        } elseif (str_contains($URL, 'state=new-delhi')) {
            $DisplayTitle = 'नई दिल्ली विधान सभा चुनाव: Latest Updates, Results, and Analysis | World 91';
            $DisplayDescription = 'नई दिल्ली विधान सभा चुनाव से जुड़ी ताज़ा खबरें, चुनाव परिणाम और राजनीतिक विश्लेषण पढ़ें। नई दिल्ली विधानसभा चुनाव के नतीजे और सभी महत्वपूर्ण घटनाओं की जानकारी पाएं World 91 पर।';
        } elseif (str_contains($URL, 'state=bihar')) {
            $DisplayTitle = 'बिहार विधान सभा चुनाव: Latest Updates, Results, and Analysis | World 91';
            $DisplayDescription = 'बिहार विधान सभा चुनाव से जुड़ी ताज़ा खबरें, चुनाव परिणाम और विश्लेषण पढ़ें। बिहार विधानसभा चुनाव के नतीजे और सभी प्रमुख घटनाओं की जानकारी पाएं World 91 पर।';
        } elseif ($URL == '/state-legislative-assembly-election') {
            $DisplayTitle = 'राज्य विधान सभा चुनाव 2024: ताजा अपडेट्स और चुनावी विश्लेषण | world91 न्यूज | world91.com';
            $DisplayDescription = 'राज्य विधान सभा चुनाव 2024 से जुड़ी सभी एक्सक्लूसिव खबरें और ताजा अपडेट्स पाएं। जानें प्रमुख पार्टियों, उम्मीदवारों और चुनावी रणनीतियों का गहराई से विश्लेषण केवल World 91 – जिस पर देश करता है भरोसा। पर।';
            ...
            $DisplayTitle = 'world91 न्यूज - एक क्लिक में पढ़ें ' . $formattedDate . ' की अहम खबरें - ' . $todayEng . ' breaking latest news';
            ...
            $DisplayTitle = 'World 91 - जिस पर देश करता है भरोसा | Trusted Global Affairs Insights';
            $DisplayDescription = 'World 91 – जिस पर देश करता है भरोसा। पर पाएं रक्षा, कूटनीति और वैश्विक संबंधों पर ताज़ा खबरें, विश्लेषण और विशेषज्ञ दृष्टिकोण।';
        }
        if ($statepos > 0) {
    ...
    <meta property="og:site_name" content="world91" />
    ...
    $slug = $get_baseUrl . 'breakingnews/latest-breaking-news-in-hindi-world91news-' . $todayEng;
    ?>
    ...
    <meta name="twitter:site" content="world91">
...
<body data-rsssl="1"
    ...
    <div class="page-wrapper">
                ...
                <div class="--header-container">
                    <div class="--header-left">
                        <a href="/" class="--world91-logo">
                            <img src="https://www.world91.com/frontend/images/logo.png" alt="Logo"
                                class="--logo" />
                        </a>
                    </div>
                    <div class="--header-right">
                        <div class="--header-right-top">
                            <div class="--hdr-top">
                                ...
                                <div class="--hdr-t-r">
                                    <div class="pod-cast">
                                        <a href="https://www.world91.com/being-ghumakkad"><img loading="lazy"
                                                style="width: 30px;" src="https://www.world91.com/file/bg_icon.png"
                                                alt=""></a>
                                        <a href="https://www.world91.com/Podcast"><img loading="lazy"
                                                style="width: 54px;"
                                                src="https://www.world91.com/file/podcost_icon.png"
                                                alt=""></a>
                                    </div>
                                    <div class="social-wrap">
                                        <a href="https://www.facebook.com/officialworld91news" target="_blank"
                                ...
                                <div class="modal-content">
                                    <div class="modal_top">
                                        ...
                                        <a href="{{ asset('/') }}" class="modal_logo"><img loading="lazy"
                                                src="https://www.world91.com/frontend/images/logo.png" alt=""></a>
                                    ...
                                    <div id="" class="inner-nav cm-container">
                                        <ul class="menuSearch menuSearchalign-end navmenu">
                                            ...
                                            <li id="navLogo"
                                                ...
                                                <a class="sub_logo" href="https://www.world91.com/"
                                                    aria-current="page">
                                                    <img loading="lazy"
                                                        src="https://www.world91.com/frontend/images/logo.png"
        ...
        <div class="btm-nav">
            ...
            <a href="{{ url('/world91videos') }}" class="nav-item">
                    ...
                    <div class="footer_left">
                        <div class="footer_logo_wrap">
                            ...
                            <div class="footer_logo">
                                <img loading="lazy" src="https://www.world91.com/banner/logo.png" alt="">
                            </div>
                        </div>
