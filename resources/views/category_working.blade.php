                                ...
                                <div class="sdle-wrap">
                                    ...
                                    <div class="sdle-mid">
                                        <div class="phase-wrap">
                                            <div class="phase-l">
                                                <img class="vote-poll" src="{{ asset('asset/images/vote-graph.png') }}" alt="Vote poll">
	...
	{{-- NL1031: 19.09.2025 : removed --}}
                            ...
                            <div class="cm-container">
                                <div class="election-wrap ew-m">
                                    <div class="el-img">
                                        <img src="{{ config('global.base_url_asset') }}asset/images/bihar-map.png" alt="Election 2020">
                                    </div>
                                    <div class="el-row">
                                        <div class="el-left">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function createSemiCircleChart(canvasId, results, options = {}) {
                ...
                const labels = results.map(r => r.party_name);
                const values = results.map(r => r.seats_won);
                const colors = options.colors || ['#EE740F', '#6CC500', '#004DB1', 'red'];
                    ...
                    options: {
                        ...
                        plugins: {
                            legend: {
							 ...
							 // NL1031:22Sep2025: Disable tooltip 
                            tooltip: {
                                enabled: false,
                                callbacks: {
            ...
            // Example datasets
			 // NL1031:22Sep2025: Table updated
             const results1 = [{
                    party_name: "NDA",
                    seats_won: 87
                },
