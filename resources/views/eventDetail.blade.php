    ...
    <script type="application/ld+json">
        {
            ...
            "@type": "NewsArticle",
            "headline": {!! json_encode(Str::limit($data['blog']->title, 110)) !!},
                        ...
                        <script type="application/ld+json">
                            {
                                ...
                                "itemListElement": [
                                    ...
                                    "@type": "ListItem",
                                    "position": 3,
                                    "name": {!! json_encode($data['blog']->title) !!},
                                    "item": "{{ url()->current() }}"
                                    }
                                ]
                            }
                                    ...
                                    <div class="col_left">             
                                        <div class="main_article_wrap">
                                            <div class="main_article">
                                                ...
                                                <p class="rt_sub">{{ $data['blog']->short_desc }}</p>
                                                ...
                                                <div class="at_img">
                                                    <figure class="relative">
                                                            ...
                                                            @php
                                                                $ff = config('global.blog_images_everywhere')(
                                                                    $data['blog'],
                                                                );
                                                            @endphp
                                                            <img src="{{ asset($data['blog']->event_image) }}"
                                                                alt="{{ $data['blog']->title }}">
                                                        {{-- Image Credit --}}
                                                        ...
                                                        <section class="cm_related_post_container">
                                                            <div class="section_inner">
                                                                ...
                                                                <div class="row tags_row ms-2">
                                                                    @foreach (explode(',', $data['blog']->tag) as $tag)
                                                                        @if (trim($tag) !== '')
