                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <form action="{{ route('voteCountList') }}" method="POST">
                                @csrf
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="number" class="form-control"
                                                            ...
                                                            placeholder="W+L" value="{{ $party->total_seats ?? 0 }}">
                                                    </td>
                                                    <td>
                                                        <input type="number" class="form-control"
                                                            name="{{ strtolower($party->abbreviation) }}_w" placeholder="W"
                                                            value="{{ $party->seats_won ?? 0 }}">
                                                    </td>
                                                    <td>
                                                        <input type="number" class="form-control"
                                                            name="{{ strtolower($party->abbreviation) }}_l" placeholder="L"
                                                            value="{{ $party->seat_loss ?? 0 }}">
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
