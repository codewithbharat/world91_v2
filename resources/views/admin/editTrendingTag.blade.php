                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                            <div class="card-header " style="padding-block: 20px;">
                                <h3 class="card-title mb-0 fs-5">Edit Trending Topic Tag</h3>
                            </div>
                            <div class="uploads-container row">
                                <form action="{{ asset('posts/trendingtopictag/edit') }}/{{ $get_tag->id }}" method="post" class="uploads col-md-6 mt-3"
                                    style="max-width: 500px">
                                    @csrf
                                    <div class=" input-field mb-4">
                                        <input placeholder="" autocomplete="off" type="text" name="name"
                                           value="{{ $get_tag->name }}" id="name" oninput="clearError('name-error')">
