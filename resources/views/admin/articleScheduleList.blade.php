                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center px-5 py-2.5">
                                <h3 class="card-title mb-0 fs-5">SCHEDULED ARTICLES</h3>
                                <div class="card-tool ">
                            ...
                            <div class="card-body table-responsive py-2">
                                <table class="table article-table at-draft text-nowrap">
                                    <thead>
                                        <tr>
                                            <th>Action</th>
                                            <th>ID</th>
                                        ...
                                        @if (count($data['blogs']) > 0)
                                            @foreach ($data['blogs'] as $blog)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span
                                                            class="status {{ $blog->status == App\Models\Blog::STATUS_DRAFT ? 'status-pending' : 'status-unknown' }}">
                                                            {{ $blog->status == App\Models\Blog::STATUS_SCHEDULED ? 'Scheduled' : 'Unknown' }}
                                                        </span>
                                                    </td>
