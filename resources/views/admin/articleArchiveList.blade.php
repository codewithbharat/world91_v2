                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center px-5 py-2.5">
                                <h3 class="card-title mb-0 fs-5">ARCHIVED ARTICLES</h3>
                                <div class="card-tool ">
                                        ...
                                        @if (count($data['blogs']) > 0)
                                            @foreach ($data['blogs'] as $blog)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span
                                                            class="status {{ $blog->status == App\Models\Blog::STATUS_ARCHIVED ? 'status-archive' : 'status-unknown' }}">
                                                            {{ $blog->status == App\Models\Blog::STATUS_ARCHIVED ? 'Archived' : 'Unknown' }}
                                                        </span>
                                                    </td>
                                                    ...
                                                    <td class="text-nowrap">
                                                        <a class="act_btn"
                                                            href="{{ asset('posts/del/') }}/{{ $blog->id }}?status={{ $blog->status }}"
                                                            onclick="openDeleteModal(this,'Are you sure you want to delete this item permanently?'); return false;">
