                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center px-5 py-2.5">
                                <h3 class="card-title mb-0 fs-5">LIVE ARTICLES UPDATES </h3>
                                <div class="card-tool ">
                                    <div class="input-group input-group-sm float-right  ">
                                        <a href="{{ asset('posts') }}/addlive" class="--btn" style="background: #28364f">
                                            Add Live Article
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="card-body table-responsive py-2 px-0">
                                <table class="table article-table text-nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        @if (count($data['liveBlogs']) > 0)
                                            @foreach ($data['liveBlogs'] as $blog)
                                                <?php
                                                ...
                                                <tr>
                                                    <td class="text-nowrap mx-auto">
                                                        ...
                                                        <a class="act_btn"
                                                            href="{{ asset('posts/editlive') }}/{{ $blog->id }}?from={{ request()->segment(2) }}&status={{ $filteredstatus }}&t={{ time() }}">
                                                    ...
                                                    <td style="white-space: pre-wrap; word-wrap: break-word; width: 290px;">{{ $blog->update_title }}</td>
                                                    ...
                                                    <td><a class="act_btn"
                                                            href="{{ asset('posts/deletelive/') }}/{{ $blog->id }}?from={{ request()->segment(2) }}&status={{ $blog->status }}"
                            ...
                            <div class="row pagination-block px-5">
                                <div class="col-sm-12 col-md-5">
                                    <div class="dataTables_info" id="dataTableExample_info" role="status"
                                        aria-live="polite">
                                        @if ($data['liveBlogs']->count() > 0)
                                            Showing {{ $data['liveBlogs']->firstItem() }} to {{ $data['liveBlogs']->lastItem() }}
                                            of {{ $data['liveBlogs']->total() }} entries
                                        @else
                                            Showing 0 entries
                                        @endif
                                    </div>
