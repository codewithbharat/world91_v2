                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item">Reset Password</a></li>
                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                            <div class="card-header " style="padding-block: 20px;">
                                <h3 class="card-title mb-0 fs-5">Reset Password</h3>
                            </div>
                            <div class="uploads-container row px-1">
                                <form method="post"
                                    action="{{ asset('alluserslist/allusers-reset-password') }}/{{ $user->id }}"
                                    ...
                                    <div class="form-group row ">
                                        <!-- <div class=" input-field col-md-4">
                                                <input placeholder="" autocomplete="off" type="password" value="{{ $user->password }}" name="password" id="password" >
