                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                            <div class="card-header " style="padding-block: 20px;">
                                <h3 class="card-title mb-0 fs-5">ADD VIDEO</h3>
                            </div>
                            <form id="videoUploadForm" class="form-group use-progress" method="POST"
                                action="{{ url('video/add') }}" enctype="multipart/form-data" data-namespace="VideoFormUtils"
                                data-validate="validateUploadForm">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <div class="input-field col-md-6">
                                            <input autocomplete="off" type="text" name="title_url" placeholder=""
                                                value="{{ old('title_url') }}" id="title_url"
                                    ...
                                    <div class="form-group row">
                                        <div class="input-field">
                                            <textarea autocomplete="off" name="description" placeholder="" id="description"
                                                oninput="VideoFormUtils.clearError('description-error')" class="input-textarea">{{ old('description') }}</textarea>
                                    ...
                                    <div class="row align-items-center justify-content-center mb-3" style="gap: 20px;">
                                        ...
                                        <div class="col-auto p-0">
                                            <img id="image-preview" src="#" alt="Preview"
                                                style="display: none; max-width: 400px; max-height: 100%; border-radius: 6px; border: 1px solid #ddd; background: #f8f8f8;" />
                                        </div>
                                        <div class="col-auto p-0">
                                            <video id="video-preview" controls
                                                style="display: none; max-width: 400px; max-height: 100%; border-radius: 6px; border: 1px solid #ddd; background: #f8f8f8;"></video>
                                        </div>
                                    </div>
                            ...
                            <x-progress-modal message="Uploading your video..." />
                        </div>
                    </div>
                </div>
            </div>
        ...
        document.getElementById('video_file').addEventListener('change', function(event) {
            ...
            if (file) {
                ...
                if (isTooLarge) {
                    ...
                    alert('Video file size exceeds 300 MB. Please select a smaller file. Selected size: ' + sizeInMB + ' MB ');
                    event.target.value = '';
                    return;
                }
            } else {
