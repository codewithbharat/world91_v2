                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center px-5 py-2.5">
                                <h3 class="card-title mb-0 fs-5">UNPUBLISHED ARTICLES</h3>
                                <div class="card-tool ">
                                        ...
                                        @if (count($data['blogs']) > 0)
                                            @foreach ($data['blogs'] as $blog)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span
                                                            class="status {{ $blog->status == App\Models\Blog::STATUS_UNPUBLISHED ? 'status-unpublished' : 'status-unknown' }}">
                                                            {{ $blog->status == App\Models\Blog::STATUS_UNPUBLISHED ? 'Unpublished' : 'Unknown' }}
                                                        </span>
                                                    </td>
