                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header d-flex justify-content-between align-items-center"
                                ...
                                <h3 class="card-title mb-0 fs-5">ADD HOME CATEGORY</h3>
                            </div>

                            <form class="form-group" method="post" action="{{ asset('home-category/add') }}"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="input-field col-md-6">
                                            <select id="catid" class="form-select" name="catid"
                                                ...
                                                @if (old('catid'))
                                                    <option value="{{ old('catid') }}" selected>
                                                        {{ $categories->firstWhere('id', old('catid'))->name }}</option>
                                                @endif
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <select class="js-example-basic-single form-select" data-width="100%"
                                                id="type" name="type" oninput="clearError('type-error')">
                                    ...
                                    <div class="form-group row" id= "banner_section">
                                        ...
                                        <div class="input-field col-md-6">
                                            <input type="text" id="image_url" name="image_url" placeholder=""
                                                value="{{ old('image_url') }}" oninput="clearError('image_url-error')" />
                                    ...
                                    {{-- Section Order and Sidebar Order --}}
                                    <div class="form-group row" id= "sequence_order">
                                        <div class="input-field col-md-6" id="section_order">
                                            ...
                                            <input type="number" name="section_order" placeholder=""
                                                value="{{ old('section_order', ($maxSectionOrder ?? 0) + 1) }}"
                                            ...
                                            @error('section_order')
                                                <div class="input-group-append" id="section_order-error">
                                                    <div class="input-group-text">
                                                        <span class="me-1"><i class="fa-solid fa-circle-exclamation"></i>
                                                            {{ $errors->first('section_order') }}</span>
                                                    </div>
                                                </div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="input-field col-md-6" id="sidebar_sec_order">
                                            ...
                                            <input type="number" name="sidebar_sec_order" placeholder=""
                                                value="{{ old('sidebar_sec_order', ($maxSidebarOrder ?? 0) + 1) }}"
                                            ...
                                            @error('sidebar_sec_order')
                                                <div class="input-group-append" id="sidebar_sec_order-error">
                                                    <div class="input-group-text">
                                                        <span class="me-1"><i class="fa-solid fa-circle-exclamation"></i>
                                                            {{ $errors->first('sidebar_sec_order') }}</span>
                                                    </div>
                                                </div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="button-container row">
                                        <button class="--btn btn-publish" type="submit" name="submit">Add</button>
                                    </div>
                                </div>
                            </form>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function toggleFields(clear = false) {
            ...
            if (selected === 'section') {
                ...
                bannerSection.style.display = 'flex'; // or 'block' depending on your layout
            }

            // Handle Category field requirement based on type
            const catidSelect = document.getElementById('catid');
            if (['banner', 'other'].includes(selected)) {
                catidSelect.value = '0'; // reset to "Select Category"
