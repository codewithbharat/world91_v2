                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                            <div class="card-header " style="padding-block: 20px;">
                                <h3 class="card-title mb-0 fs-5">Add Vote</h3>
                            </div>
                            <form class="form-group" method="post" action="{{ asset('/vote/add') }}"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <div class="form-group row">
                                        <div class="input-field col-md-12">
                                            <input class="at-title" autocomplete="off" type="text" name="title" value="{{ old('title') }}"
