...
@push('plugin-styles')
  <link href="{{ asset('asset/new_admin/assets/plugins/flatpickr/flatpickr.min.css') }}" rel="stylesheet" />
@endpush
...
@push('plugin-scripts')
  <script src="{{ asset('asset/new_admin/assets/plugins/flatpickr/flatpickr.min.js') }}"></script>
  <script src="{{ asset('asset/new_admin/assets/plugins/apexcharts/apexcharts.min.js') }}"></script>
@endpush

@push('custom-scripts')
  <script src="{{ asset('asset/new_admin/assets/js/dashboard.js') }}"></script>
@endpush