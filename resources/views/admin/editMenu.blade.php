                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header " style="padding-block: 20px;">
                                <h3 class="card-title mb-0 fs-5">Edit Menu</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <?php $menu_data = $data['menu']; ?>
                            <form class="form-group" method="post" aaction="{{ asset('menu/edit') }}/{{ $menu_data->id }}"
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        <div class="input-field col-md-4">
                                            <input placeholder="" autocomplete="off" type="text" name="name"
                                                id="name" value="{{ $menu_data->menu_name }}"
                                        ...
                                        <div class="input-field col-md-4">
                                            <input placeholder="" autocomplete="off" type="text" name="link"
                                                id="link" value="{{ $menu_data->menu_link }}"
                                        ...
                                        <div class="input-field col-md-4 d-none">
                                            <input placeholder="" autocomplete="off" type="text" name="class"
                                                id="class" value="{{ $menu_data->menu_class }}"
                                                oninput="clearError('class-error')" />
                                        ...
                                        <div class="input-field col-md-4">
                                            <select class="js-example-basic-single form-select" data-width="100%"
                                                ...
                                                @foreach ($data['menus'] as $menu)
                                                    <option value="{{ $menu->id }}" <?php if ($menu_data->menu_id == $menu->id) {
                                                        echo 'selected';
                                                    } ?>>
                                        ...
                                        <div class="input-field col-md-4">
                                            <select class="js-example-basic-single form-select" data-width="100%"
                                                ...
                                                @foreach ($data['types'] as $type)
                                                    <option value="{{ $type->id }}" <?php if ($menu_data->type_id == $type->id) {
                                                        echo 'selected';
                                                    } ?>>
                                                        {{ $type->type }}</option>
                                                @endforeach
                                        ...
                                        <div class="input-field col-md-4">
                                            <select class="js-example-basic-single form-select" data-width="100%"
                                                ...
                                                @foreach ($data['categories'] as $category)
                                                    <option value="{{ $category->id }}" <?php if ($menu_data->category_id == $category->id) {
                                                        echo 'selected';
                                                    } ?>>
                                    ...
                                    <div class="checkbox-wrapper-46">
                                        <input type="checkbox" id="cbx-46" name="status" <?php if ($menu_data->status == 1) {
                                            echo 'checked';
                                        } ?>
                                            class="inp-cbx" />
