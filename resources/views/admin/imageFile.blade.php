                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center px-5 py-2.5">
                                <h3 class="card-title mb-0 fs-5">IMAGE LIST</h3>

                                <div class="card-tool ">
                                    <div class="input-group input-group-sm float-right  ">

                                        <a href="{{ asset('files') }}/add" class="--btn" style="background: #28364f">
                                            ADD IMAGE FILE
                                        </a>
                                                ...
                                                @foreach ($data['files'] as $file)
                                                    ...
                                                    <tr>
                                                        @if ($file->file_type == 'image/jpeg' || $file->file_type == 'image/png')
                                                            <td>{{ $file->id }}</td>
                                                            <td style="max-width: 200px;">{{ $file->file_name }}</td>
                                                            <td style="max-width: 200px;"><a href="{{ asset($imageFilePath) }}" target="_blank">{{ asset($imageFilePath) }}</a></td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <div class="image-preview" width="100%" controls>
                                                                    <img src="{{ asset($imageFilePath) }}" />
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <a class="act_btn"
                                                                    href="{{ asset('files/edit') }}/{{ $file->id }}"><i class="fa-solid fa-pen-to-square"></i></a>
                                                                {{-- <a class="act_btn"
                                                                    href="{{ asset('files/delete/') }}/{{ $file->id }}"><i class="fa-solid fa-trash"></i></a> --}}
                                                            </td>
                                                        @endif
                                                    </tr>
                                                @endforeach
