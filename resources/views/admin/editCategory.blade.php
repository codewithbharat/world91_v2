                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item">Edit Category</a></li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                            <div class="card-header " style="padding-block: 20px;">
                                <h3 class="card-title mb-0 fs-5">Edit Category</h3>
                            </div>
                            <div class="uploads-container row px-1">
                                <form method="post" action="{{ asset('categories/edit') }}/{{ $data['singleCate']->id }}"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group row ">
                                        <div class=" input-field col-md-6">
                                            <input placeholder="" autocomplete="off" type="text" name="name"
                                                value="{{ $data['singleCate']->name }}" id="name"
                                        ...
                                        <div class=" input-field col-md-6">
                                            <input placeholder="" autocomplete="off" type="text" name="eng_name"
                                                value="{{ $data['singleCate']->eng_name }}" id="eng_name"
                                                oninput="clearError('eng_name-error')">
                                            <label for="name">Category English Name <span class="text-danger">*</span></label>
                                            @error('eng_name')
                                        ...
                                        <div class=" input-field col-md-6">
                                            <select class="js-example-basic-single form-select" data-width="100%"
                                                ...
                                                @foreach ($data['categories'] as $category)
                                                    <option value="{{ $category->id }}" <?php if ($data['singleCate']->category_id == $category->id) {
                                                        echo 'selected';
                                                    } ?>>
                                    ...
                                    <div class="checkbox-wrapper-46">
                                        <input type="checkbox" id="cbx-46" name="home_page_status" <?php if ($data['singleCate']->home_page_status == 1) {
                                            echo 'checked';
                                        } ?>
                                            class="inp-cbx" />
