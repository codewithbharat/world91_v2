                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center px-5 py-2.5">
                                <h3 class="card-title mb-0 fs-5">LIVE ARTICLES</h3>
                                <div class="card-tool ">
                                    <div class="input-group input-group-sm float-right  ">
                                        <a href="{{ asset('/posts') }}/add?from={{ request()->segment(2) }}" class="--btn" style="background: #28364f">
                                            Add Article
                                        </a>
                                    </div>
                                </div>
                                            ...
                                            @foreach ($data['blogs'] as $blog)
                                                ...
                                                <tr>
                                                    <td class="text-nowrap mx-auto">
                                                        <a class="act_btn"
                                                            href="{{ asset('live/' . ($cat->site_url ?? '') . '/' . ($blog->site_url ?? '')) }}"
                                                    ...
                                                    <td class="text-nowrap">
                                                        <a class="act_btn"
                                                            href="{{ asset('posts/livelists') }}/{{ $blog->id }}?t={{time()}}"
