                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                            <div class="card-header " style="padding-block: 20px;">
                                <h3 class="card-title mb-0 fs-5">Edit Vote Option</h3>
                            </div>
                            <form class="form-group" method="post" action="{{ asset('vote/vote-option/edit') }}/{{ $data['option_vote']->id }}"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <div class="form-group row">
                                        <div class="input-field col-md-6">
                                            <input class="at-title" autocomplete="off" type="text" name="name" value="{{ $data['option_vote']->name }}"
                                    ...
                                    <div class="form-group row"> --}}
                                        <div class="input-field col-md-6">
                                            <select class="js-example-basic-single form-select" data-width="100%"
                                                ...
                                                <option value="0">Select Vote Title</option>
                                                @foreach ($data['get_votes'] as $get_vote)
                                                    <option value="{{ $get_vote->id }}" <?php if ($data['option_vote']->vote_id == $get_vote->id) {
                                                        echo 'selected';
