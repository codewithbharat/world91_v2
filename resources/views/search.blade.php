            ...
            <div id="primary" class="content-area" style="transform: none;">
                <main id="main" class="site-main" style="transform: none;">
                    <div class="cm_archive_page" style="transform: none;">
                                ...
                                <ul class="trail-items" itemscope="" itemtype="http://schema.org/BreadcrumbList">
                                    ...
                                    <li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem"
                                        class="trail-item trail-end"><a href="#" itemprop="item"><span
                                                ...
                                                for : {{ isset($search) ? $search : '' }}</span></a>
                        ...
                        <x-horizontal-ad :ad="$searchAd['category_header_ad'] ?? null" />
                            ...
                            <div class="cm-container">
                                <div class="news_main_row">
                                        ...
                                        <div class="news_sub_wrap">
                                            <ul class="nws_list">
                                                @foreach ($blogs->skip(5)->take(15) as $blog)
                                                    ...
                                                    @if ($loop->iteration === 5)
                                                            <li>
                                                                <x-horizontal-sm-ad :ad="$searchAd['category_middle_horz_sm_ad1'] ?? null" />
                                                            </li>
                                                        @endif
                                                @endforeach
                                            </ul>
                                    ...
                                    <div class="col_right">
                                        ...
                                        <x-vertical-sm-ad :ad="$searchAd['category_sidebar_vaerical_ad1'] ?? null" />
                                        ...
                                        <x-vertical-sm-ad :ad="$searchAd['category_sidebar_vaerical_ad2'] ?? null" />

                                    </div>
                                </div>

                                {{-- Horizontal-2 Advertise --}}
                                <x-horizontal-ad :ad="$searchAd['category_bottom_ad'] ?? null" />
